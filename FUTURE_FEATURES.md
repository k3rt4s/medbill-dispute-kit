...
- **turquoise**, Turquoise Health API for live cross-hospital negotiated rates. Points at "Turquoise Health API integration". Parked pending the **vendor-memos** item on the work board, which settles whether their terms allow open-source non-commercial use. `score: kind=feature gain=1/3/8 p=0.1 freq=4 hours=2/4/8 ai=15 risk=0.1x3 rev=two-way conf=opinion id=turquoise` Research memo: `C:\Code_data\medbill-dispute-kit\reports\vendor_memo_turquoise_2026-09-06.md` (read 2026-09-07); verdict: needs a direct request because published terms restrict external dissemination and do not establish an open-source license.
...
- **dollarfor**, Dollar For charity-care screener integration. Points at "Dollar For screener integration". Parked pending the same **vendor-memos** item, which settles whether Dollar For has an API at all. `score: kind=feature gain=2/5/15 p=0.15 freq=2 hours=1.5/3/6 ai=10 risk=0.1x2 rev=two-way conf=opinion id=dollarfor` Research memo: `C:\Code_data\medbill-dispute-kit\reports\vendor_memo_dollarfor_2026-09-06.md` (read 2026-09-07); verdict: needs a direct request because no public API or governing integration terms were verified from accessible published sources.
