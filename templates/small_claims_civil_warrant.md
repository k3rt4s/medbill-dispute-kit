...
```letter
IN THE [GENERAL SESSIONS / SMALL CLAIMS / JUSTICE] COURT
FOR [COUNTY] COUNTY, [STATE]

[PATIENT FULL NAME],
Plaintiff,

v.                                                Civil Warrant No. _________

[DEFENDANT LEGAL NAME] d/b/a [DEFENDANT D/B/A NAME IF ANY],
Defendant.


CIVIL WARRANT AND STATEMENT OF CLAIM


To the Sheriff or any constable of [COUNTY] County, [STATE]:

Summon [DEFENDANT LEGAL NAME] to appear before the [General Sessions / Small Claims] Court of [COUNTY] County at the courthouse located at [COURTHOUSE ADDRESS] on the date set by the Clerk, to answer the civil claim of [PATIENT FULL NAME] as follows.

I. Parties and jurisdiction

1. Plaintiff [PATIENT FULL NAME] is a natural person residing at [STREET ADDRESS], [CITY], [STATE] [ZIP].
...
6. On [DATE OF SERVICE], Plaintiff received medical services from Defendant. The services are documented on Defendant's itemized bill, account number [ACCOUNT NUMBER], dated [STATEMENT DATE]. A true copy of the itemized bill is attached as Exhibit A.

7. Plaintiff's health plan, [INSURER NAME], adjudicated the corresponding claim and issued an Explanation of Benefits dated [EOB DATE], claim number(s) [CLAIM NUMBERS], identifying the plan-allowed amount and the patient responsibility. A true copy of the EOB is attached as Exhibit B.

8. Defendant asserts a current balance owed by Plaintiff of $[CURRENT BALANCE]. This amount [exceeds the plan-allowed amount on the EOB by $[SPREAD] / is [N] times the Medicare allowable rate for the services billed / exceeds Defendant's own published cash price for the same services under 45 CFR Part 180 by $[SPREAD]].

9. On [DATE OF FIRST DISPUTE LETTER], Plaintiff sent Defendant a written dispute by certified mail (USPS tracking [TRACKING NUMBER]) requesting [an itemized bill / a correction to the asserted balance / reprocessing under in-network cost-sharing / honoring of the No Surprises Act / a good-faith price under UCC § 2-305(2)]. A copy of the dispute letter and the certified-mail green card are attached as Exhibit C.

10. Defendant [did not respond / responded on [DATE] without addressing the substance of the dispute, see Exhibit D].

11. On [DATE OF 30-DAY WARNING], Plaintiff sent Defendant a 30-day warning by certified mail (USPS tracking [TRACKING NUMBER]) notifying Defendant that Plaintiff would file this civil action if the dispute remained unresolved past [DEADLINE DATE]. A copy of the warning and the certified-mail green card are attached as Exhibit E.

12. As of the date of filing, the dispute remains unresolved.
...
14. Under [STATE] Uniform Commercial Code § 2-305(2) (or its common-law analogue under quantum meruit), Defendant is obligated to set the price of services in good faith. A price multiple times the Medicare allowable rate, Defendant's own published cash price, and the rate every commercial insurer pays for the same service is not a good-faith open price term.
...
17. The federal No Surprises Act prohibits Defendant from billing Plaintiff at an out-of-network rate for these services and limits Plaintiff's cost-sharing to the in-network amount under Plaintiff's health plan.
...
20. As of [DATE], Defendant [does not publish a compliant machine-readable file / publishes a file that omits the services on Plaintiff's bill]. Plaintiff has filed a parallel complaint with the Centers for Medicare and Medicaid Services.
...
26. On [DATE OF FDCPA VALIDATION REQUEST], within 30 days of Plaintiff's receipt of Defendant's initial collection communication, Plaintiff sent Defendant a written request for validation of the debt pursuant to 15 U.S.C. § 1692g(b).

27. Defendant [did not cease collection activity pending validation / did not provide validation], in violation of 15 U.S.C. § 1692g(b).

28. Plaintiff seeks statutory damages under 15 U.S.C. § 1692k(a)(2) of up to $1,000 plus costs.

IV. Damages and relief requested

29. Plaintiff respectfully requests that this Court enter judgment in Plaintiff's favor and grant the following relief:

(a) A declaratory judgment that the reasonable and good-faith price for the services giving rise to this bill is $[REASONABLE AMOUNT];

(b) An order requiring Defendant to mark account [ACCOUNT NUMBER] paid-in-full and to withdraw any credit reporting or collection referral relating to this account;

(c) Statutory damages of $[FDCPA AMOUNT, up to $1,000] under 15 U.S.C. § 1692k(a)(2), if the FDCPA claim applies;

(d) Plaintiff's filing fee and costs of suit; and

(e) Such other and further relief as the Court deems just and proper.

30. Total amount in controversy: $[AMOUNT IN CONTROVERSY, not to exceed jurisdictional limit].

V. Verification

I, [PATIENT FULL NAME], declare under penalty of perjury under the laws of [STATE] that the foregoing is true and correct to the best of my knowledge.
...
The drafter confirms (or warns the patient if any condition is unmet):

1. `dispute_letter_sent_date` is populated, certified-mail tracking is recorded, and at least 30 calendar days have elapsed since the postmark.
2. `thirty_day_warning_sent_date` is populated, certified-mail tracking is recorded, and at least 15 calendar days have elapsed since the postmark.
3. `doi_complaint_sent_date` is populated. (Filing a court action without first having a DOI complaint on file is not legally required, but it weakens the patient's negotiating position in court.)
4. The amount in controversy does not exceed the state's small-claims / general-sessions jurisdictional limit. If it does, the case must be filed in the higher trial court, which is outside the scope of this kit and warrants legal counsel.
5. The defendant is the correct legal entity. Patients sometimes mistakenly sue the doing-business-as name; the registered legal name must be on the warrant.
...
- Log this in `tracker.csv` with `small_claims_filed_date`, `small_claims_case_number`, and `small_claims_court`. Set `status = escalated`.
- Track the court date and any pre-trial mediation requirement (some counties require mediation; many do not).
- If the defendant settles before the court date, mark the account `settled` only after receiving a written settlement document signed by an authorized representative of the defendant. A phone-call promise is not a settlement.
- If the case proceeds, prepare exhibits and witnesses (the patient and, if available, the patient's primary-care or treating physician for the medical-necessity narrative). Bring three copies of every exhibit on the court date.
