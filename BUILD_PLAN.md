...
| v0.13.0 | shipped | 2026-05-21 | Marshall Allen methodology pipeline: Medicare PFS benchmarking (~150 codes), audit detector (NCCI / duplicates / modifier-25 / late-fee / service-not-received / quantity), counter-offer drafter, DOI / AG portal directory (35 states), small-claims civil-warrant, encounter clustering, MRF fetcher, SPD parser, action log, evidence bundler + rclone push, SOL tracker (50 states), state medical-debt protection summary (15 states), phone-call scripts, plus 11 new templates: dispute-reply, request-EOB, counter-offer, records-request-HIPAA, GFE-request, PPDR-initiate, lien-challenge, subrogation-response, FCRA, IDR-request, WC-redirect, 502(c)-penalty, encounter-combined, IRS 13909, attorney-intake. Epic 19 added to USER_STORIES.md with 23 new stories. |
