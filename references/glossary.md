...
**NPI, National Provider Identifier.** Ten-digit number identifying a specific health-care provider. Required on every claim. Patient can look up a provider's NPI at [npiregistry.cms.hhs.gov](https://npiregistry.cms.hhs.gov).
...
**PPDR, Patient-Provider Dispute Resolution.** Federal No Surprises Act mechanism for self-pay/uninsured patients whose final bill exceeds the GFE by $400+ from a single provider. Filed at [nsa-idr.cms.gov](https://nsa-idr.cms.gov). Collection-pause attaches during pendency.
...
**SHIP, State Health Insurance Assistance Program.** Free counseling for Medicare beneficiaries, including appeals help. Every state has one. Lookup at [shiphelp.org](https://www.shiphelp.org).
