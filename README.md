...
- [references/](references/README.md): Reference material the LLM cites when analyzing bills and drafting letters: federal laws, 40 state-law packs, CPT/HCPCS code references, a national Medicare fee-schedule lookup, NCCI unbundling…
